...
#         self.name = os.path.splitext(os.path.basename(path))[0]
        self.name = os.path.basename(os.path.dirname(path))#benyuan  shanghai qianzhan
        # self.name = os.path.basename(path)  ##qingyi  guilin
        # self.name = self.name.split(".")[0]  ##qingyi
